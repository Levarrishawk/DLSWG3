...
-- Reprogrammed Trainers
createTrainerConversationTemplate("trainer_1hsword", "jedi_pad_master", "trainer_1hsword_convotemplate")
...
-- Old Trainers All of which will need to be despawned.
