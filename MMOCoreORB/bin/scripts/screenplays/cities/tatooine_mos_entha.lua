...
function TatooineMosEnthaScreenPlay:spawnMobiles()
	...
	--Starport
	pNpc = spawnMobile("tatooine", "contractor",300,53.5956,-0.521137,38.1243,135.004,4005523)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "commoner_tatooine",60,54.6956,-0.521137,37.0243,360.011,4005523)
	self:setMoodString(pNpc, "conversation")
	...
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile("tatooine", "chassis_dealer",60,2.14833,0.639422,67.5897,224.216,4005520)
	self:setMoodString(pNpc, "neutral")
	pNpc = spawnMobile("tatooine", "farmer",300,-36.1846,1.63942,64.2406,180.002,4005525)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "commoner_technician",300,-36.1846,1.63942,63.1406,360.011,4005525)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "medic",300,-53.137,2.63942,38.7938,180.007,4005528)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "mercenary",300,-53.137,2.63942,37.6938,360.011,4005528)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "commoner_fat",300,-54.237,2.63942,38.7938,135.003,4005528)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "trainer_shipwright",60,1.0,0.6,66.7,48,4005520)
	self:setMoodString(pNpc, "conversation")
	...
	spawnMobile("tatooine", "trainer_rifleman",0,-11,1.1,-14,0,1153566)
	...
	spawnMobile("tatooine", "trainer_droidengineer",0,-0.0475945,1.13306,-14.1102,0,1153493)
	...
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "bounty_hunter",300,-3.4032,7.01,4.89576,360.011,1153497)
	self:setMoodString(pNpc, "conversation")
	...
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "sullustan_male",300,-23.4917,9.01,1.31044,0,1153499)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "commoner_fat",300,-23.4917,9.01,2.41044,180.008,1153499)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "contractor",300,17.1949,7.01,1.93821,135.005,1153501)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "brawler",300,18.2949,7.01,0.838211,0,1153501)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "farmer",300,18.2949,7.01,1.93821,180.006,1153501)
	self:setMoodString(pNpc, "conversation")
	spawnMobile("tatooine", "bounty_hunter",300,4.3863,7.01,12.7119,95.2452,1153503)
	--Lower Floor
	...
	self:setMoodString(pNpc, "calm")
	pNpc = spawnMobile("tatooine", "commoner_old",60,-11.7551,0.0100002,-1.23478,180.012,1153512)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "shadowy_figure",300,-11.7551,0.0100002,-2.33478,360.011,1153512)
	self:setMoodString(pNpc, "calm")
	pNpc = spawnMobile("tatooine", "entertainer",60,29.3646,-0.255725,-0.43765,45.001,1153522)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "medic",300,30.4646,-0.255725,-0.43765,360.011,1153522)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "contractor",300,29.3646,-0.255725,0.66235,135.003,1153522)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "brawler",300,30.4646,-0.255725,0.66235,180,1153522)
	self:setMoodString(pNpc, "angry")
	pNpc = spawnMobile("tatooine", "bounty_hunter",300,12.7978,-0.255725,9.20473,180.002,1153520)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "slave",300,12.7978,-0.255725,8.10473,360.011,1153520)
	...
	spawnMobile("tatooine", "trainer_medic",0,-16.4794,0.26,9.71928,162,1153586)
	spawnMobile("tatooine", "trainer_medic",0,-24.6019,0.26,-3.96049,212,1153586)
	spawnMobile("tatooine", "trainer_medic",0,-17.0194,0.26,-1.8269,149,1153586)
	spawnMobile("tatooine", "trainer_medic",0,28,0.26,6.3,227,1153582)
	spawnMobile("tatooine", "trainer_medic",0,20,0.26,-5.6,87,1153582)
	...
	spawnMobile("tatooine", "trainer_chef",0,-3.1,1.1,-8.4,95,1154184)
	...
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "bounty_hunter",300,29.2773,2.12878,57.8777,180.278,1153602)
	self:setMoodString(pNpc, "conversation")
	...
	self:setMoodString(pNpc, "conversation")
	spawnMobile("tatooine", "trainer_entertainer",0,17.812,2.12873,53.8433,1,1153603)
	spawnMobile("tatooine", "trainer_entertainer",0,29.9638,2.12878,73.0406,88,1153603)
	spawnMobile("tatooine", "trainer_entertainer",0,-21.3524,2.12878,74.1456,164,1153604)
	...
	spawnMobile("tatooine", "trainer_droidengineer",0,1276.55,7,3153.11,160,0)
	spawnMobile("tatooine", "trainer_architect",0,1324,7,3141,250,0)
	spawnMobile("tatooine", "trainer_chef",0,1335,7,3487,140,0)
	spawnMobile("tatooine", "trainer_rifleman",0,1310,7,3088,0,0)
	spawnMobile("tatooine", "trainer_rifleman",0,1741,7,3117,0,0)
	spawnMobile("tatooine", "trainer_pistol",0,1158,7,3110,180,0)
	...
	spawnMobile("tatooine", "trainer_medic",0,1370,7,3164,180,0)
	...
	spawnMobile("tatooine", "trainer_entertainer",0,1481,7,3267,0,0)
	spawnMobile("tatooine", "trainer_scout",0,1240,7,3356,0,0)
	spawnMobile("tatooine", "trainer_scout",0,1303,7,3199,180,0)
	spawnMobile("tatooine", "trainer_armorsmith",0,1210,7.4,3273,170,0)
	spawnMobile("tatooine", "trainer_armorsmith",0,1394,7,3447,95,0)
	...
	--Imp Npc's Outside that need to be added again once planet-swap is  in
	...
	--pNpc = spawnMobile("tatooine", "rebel_resistance_leader",400,1624.03,7.36699,3515.56,31.2213,0)
	--self:setMoodString(pNpc, "conversation")
	--pNpc = spawnMobile("tatooine", "rebel_brigadier_general",400,1616.9,11,3243.7,86.0025,0)
	--self:setMoodString(pNpc, "neutral")
	--pNpc = spawnMobile("tatooine", "rebel_brigadier_general",400,1374.6,7,3269.5,133.004,0)
	--self:setMoodString(pNpc, "neutral")
	--spawnMobile("tatooine", "rebel_brigadier_general",400,1627.95,7.34272,3524.79,42.3654,0)
	--pNpc = spawnMobile("tatooine", "rebel_obscureops_agent",400,1591.3,7,3022.2,82.0024,0)
	--self:setMoodString(pNpc, "neutral")
	--spawnMobile("tatooine", "rebel_obscureops_agent",400,1500.5,7,3158.9,359.01,0)
	--pNpc = spawnMobile("tatooine", "rebel_resistance_leader",400,1564.7,11,3232.16,357.031,0)
	--self:setMoodString(pNpc, "neutral")
	--spawnMobile("tatooine", "rebel_sergeant",400,1600.89,11,3257.09,268.945,0)
	--pNpc = spawnMobile("tatooine", "rebel_resistance_separatist",400,1536.7,10.866,3221.9,266.008,0)
	--self:setMoodString(pNpc, "neutral")
	--spawnMobile("tatooine", "rebel_trooper",400,1603.71,11,3257.47,290.005,0)
	--pNpc = spawnMobile("tatooine", "rebel_trooper",400,1598.5,11,3190.98,71.1851,0)
	--self:setMoodString(pNpc, "neutral")
	--pNpc = spawnMobile("tatooine", "rebel_trooper",400,1736.6,7.6,3193.1,178.005,0)
	--self:setMoodString(pNpc, "neutral")
	--pNpc = spawnMobile("tatooine", "rebel_trooper",400,1713.3,7,3149.1,176.005,0)
	--self:setMoodString(pNpc, "neutral")
	--pNpc = spawnMobile("tatooine", "rebel_trooper",400,1686.8,7,3127.2,358.011,0)
	--self:setMoodString(pNpc, "neutral")
	--pNpc = spawnMobile("tatooine", "rebel_trooper",400,1757.6,7,3188.1,78.0023,0)
	--self:setMoodString(pNpc, "neutral")
	--pNpc = spawnMobile("tatooine", "rebel_trooper",400,1661,7,3111.8,147.004,0)
	--self:setMoodString(pNpc, "neutral")
	--pNpc = spawnMobile("tatooine", "rebel_trooper",400,1635.2,7,2982.3,181.005,0)
	--self:setMoodString(pNpc, "neutral")
	--pNpc = spawnMobile("tatooine", "rebel_trooper",400,1555.7,9.5,3043.7,173.005,0)
	--self:setMoodString(pNpc, "neutral")
	--spawnMobile("tatooine", "rebel_trooper",400,1506.1,7,3129.9,174.005,0)
	--spawnMobile("tatooine", "rebel_trooper",400,1442.6,7,3108.9,90.0027,0)
	--spawnMobile("tatooine", "rebel_trooper",400,1378.4,9.5,3014.4,181.005,0)
	--spawnMobile("tatooine", "rebel_trooper",400,1331.6,7,3492,93.0027,0)
	--spawnMobile("tatooine", "rebel_trooper",400,1284.3,7.7102,2956.7,42.0012,0)
	--spawnMobile("tatooine", "rebel_trooper",400,1179.3,7,3089.9,281.008,0)
	--spawnMobile("tatooine", "rebel_trooper",400,1262,7,3161.3,278.008,0)
	--spawnMobile("tatooine", "rebel_trooper",400,1270.7,7,3257.9,87.0026,0)
	--spawnMobile("tatooine", "rebel_trooper",400,1429.6,9.5,3374.5,181.005,0)
	--spawnMobile("tatooine", "rebel_trooper",400,1623.7,7,2980.1,137,0)
	--spawnMobile("tatooine", "rebel_trooper",400,1624.92,7.34652,3514.12,27.1283,0)
	--pNpc = spawnMobile("tatooine", "rebel_trooper",400,1596.04,11,3190.15,71.1795,0)
	--self:setMoodString(pNpc, "neutral")
	--pNpc = spawnMobile("tatooine", "rebel_trooper",400,1405.2,7.6,3474.1,175,0)
	--self:setMoodString(pNpc, "neutral")
	--spawnMobile("tatooine", "rebel_trooper",400,1622.2,7.41708,3518.48,81.6028,0)
	--pNpc = spawnMobile("tatooine", "rebel_medic",400,1485.2,7,3242.8,318.009,0)
	--self:setMoodString(pNpc, "npc_consoling")
	--pNpc = spawnMobile("tatooine", "rebel_medic",400,1453.2,7,3234.5,188.006,0)
	--self:setMoodString(pNpc, "neutral")
	--spawnMobile("tatooine", "rebel_medic",400,1595.4,11,3188.76,74.2722,0)
	--pNpc = spawnMobile("tatooine", "rebel_commando",400,1287.2,7,3130,26.0008,0)
	--self:setMoodString(pNpc, "neutral")
	--pNpc = spawnMobile("tatooine", "rebel_commando",400,1280.4,7,3135.1,28.0008,0)
	--self:setMoodString(pNpc, "neutral")
	--spawnMobile("tatooine", "rebel_commando",400,1318.9,9.5,3384.9,90.0027,0)
	--spawnMobile("tatooine", "rebel_staff_corporal",400,1399,7,3096.3,267.747,0)
	--spawnMobile("tatooine", "rebel_staff_corporal",400,1397.4,7,3096.3,268.154,0)
	--spawnMobile("tatooine", "rebel_staff_corporal",400,1626.23,7.32035,3514.41,23.9809,0)
	--pNpc = spawnMobile("tatooine", "rebel_staff_corporal",400,1563.41,11,3237.35,191.674,0)
	--self:setMoodString(pNpc, "neutral")
	--spawnMobile("tatooine", "rebel_staff_corporal",400,1621.03,7.45177,3518.22,42.7463,0)
	--spawnMobile("tatooine", "rebel_army_captain",400,1398.2,7,3092.2,241.546,0)
	--spawnMobile("tatooine", "rebel_resistance_anarchist",400,1254,7.7102,2956.3,306.009,0)
