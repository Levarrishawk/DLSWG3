...
--	pNpc = spawnMobile("naboo", "trainer_shipwright",60,-0.4,0.6,67.1,-177,4215410)
	...
	spawnMobile("naboo", "trainer_armorsmith",0,4823.13,4.17,-4705.34,81,0)
	spawnMobile("naboo", "trainer_rifleman",0,4800,4.17,-4734,151,0)
	spawnMobile("naboo", "trainer_pistol",0,4999,3.8,-4926,-12,0)
	spawnMobile("naboo", "trainer_chef",0,4942,3.8,-4837,180,0)
	spawnMobile("naboo", "trainer_entertainer",0,4730,3.75,-4872,44,0)
	spawnMobile("naboo", "trainer_medic",0,4887,3.8,-4899,180,0)
	...
	spawnMobile("naboo", "trainer_architect",0,-0.0177415,1.13306,-13.3088,0,1717546)

	--Guild Hall 4721 -4966
	spawnMobile("naboo", "trainer_rifleman",0,-11.0386,1.13306,-13.0273,0,1717535)
	...
	spawnMobile("naboo", "trainer_chef",0,-2.5,1.13306,-8.4,91,1717556)

	--Med Center
	spawnMobile("naboo", "trainer_medic",0,27.0188,0.26,5.47931,82,1717502)
	spawnMobile("naboo", "trainer_medic",0,-16.404,0.26,10.6808,172,1717506)
	spawnMobile("naboo", "trainer_medic",0,19.6344,0.26,-4.81265,37,1717502)
	spawnMobile("naboo", "trainer_medic",0,-25,0.26,-4,180,1717506)
