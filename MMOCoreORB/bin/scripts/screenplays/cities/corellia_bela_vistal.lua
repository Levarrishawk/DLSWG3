...
function BelaVistalScreenPlay:spawnMobiles()
	...
	spawnMobile("corellia", "trainer_rifleman", 0, -11, 1.13306, -14,0, 2365770)
	...
	spawnMobile("corellia", "trainer_chef", 0, 0, 1.13306, -14, 0, 2365947)
	...
	spawnMobile("corellia", "trainer_armorsmith", 0, -2.5, 1.13306, -8.4, 91, 2365801)

	--Outside Trainers
	spawnMobile("corellia", "trainer_pistol", 0, 6755.99, 314.994, -5655.01, 269, 0)
	...
	spawnMobile("corellia", "trainer_smuggler", 0, 6737.85, 315, -5491.3, 31, 0)
