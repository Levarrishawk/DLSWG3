...
function NabooTheedScreenPlay:spawnMobiles()
	...
	spawnMobile("naboo", "trainer_1hsword",0,-5382,6,4327,180,0)
	spawnMobile("naboo", "trainer_architect",0,-4931,6,4020,39,0)
	spawnMobile("naboo", "trainer_armorsmith",0,-4946,6,4131,138,0)
	spawnMobile("naboo", "trainer_merchant",0,-5996.85,6,4287.56,69,0)
	spawnMobile("naboo", "trainer_creaturehandler",0,-5017,6,4009,0,0)
	spawnMobile("naboo", "trainer_rifleman",0,-5942,6,4253,169,0)
	spawnMobile("naboo", "trainer_pistol",0,-4858,6,4087,-47,0)
	spawnMobile("naboo", "trainer_smuggler",0,-4684,6,3947,-71,0)
	spawnMobile("naboo", "trainer_chef",0,-4877,6,4065,0,0)
	spawnMobile("naboo", "trainer_medic",0,-5038,6,4146,180,0)
	...
	spawnMobile("naboo", "trainer_bountyhunter",0,-5375.06,6,4310.92,84,0)
	...
	spawnMobile("naboo", "trainer_squadleader",0,-5649,6,4206,0,0)
	...
	--Med Center
	spawnMobile("naboo", "trainer_medic",0,-16.4871,0.26,10.7738,176,1697364)
	spawnMobile("naboo", "trainer_medic",0,26.5469,0.26,5.31169,90,1697360)
	spawnMobile("naboo", "trainer_medic",0,16.0979,0.26,-0.105232,266,1697360)
	...
	spawnMobile("naboo", "trainer_rifleman",0,-11,1,-13,0,1692075)
	...
	spawnMobile("naboo", "trainer_architect",0,0.0417929,1.13306,-13.5584,2,1692084)
	...
	spawnMobile("naboo", "trainer_chef",0,-3.1,1.1,-8.2,91,1692094)
