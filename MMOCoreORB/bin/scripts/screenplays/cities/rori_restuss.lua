...
--	self:setMoodString(pNpc, "conversation")
	...
	spawnMobile("rori", "trainer_droidengineer", 0, 0, 1.1, -14, 0, 4635664)
	spawnMobile("rori", "trainer_merchant", 0, 5256, 80, 5600, 13, 0)
	spawnMobile("rori", "trainer_rifleman", 0, -11, 1, -14, 0, 4635691)
	spawnMobile("rori", "trainer_squadleader", 0, 5335.31, 80, 5530.48, 0, 0)
	spawnMobile("rori", "trainer_chef", 0, 5181, 80, 5668, 180, 0)
	spawnMobile("rori", "trainer_medic", 0, -16.3425, 0.26, 10.8489, 168, 4635732)
	spawnMobile("rori", "trainer_medic", 0, 26.6144, 0.26, 5.52845, 84, 4635728)
	...
	spawnMobile("rori", "trainer_entertainer", 0, 17.9253, 2.12876, 53.5327, 0, 4635754)
	spawnMobile("rori", "trainer_entertainer", 0, 5437, 80.6, 5564, 270, 0)
	spawnMobile("rori", "trainer_medic", 0, 20.8797, 0.26, -4.8809, 46, 4635728)
	spawnMobile("rori", "trainer_scout", 0, 5373, 80, 5589, 180, 0)
	...
	spawnMobile("rori", "trainer_entertainer", 0, -21.5126, 2.12878, 74.0536, 181, 4635404)
	spawnMobile("rori", "trainer_entertainer", 0, -22.3, 2.1, 73.1, 90, 4635755)
	spawnMobile("rori", "trainer_entertainer", 0, 5255, 80, 5850, 180, 0)
	spawnMobile("rori", "trainer_marksman", 0, 0, 0, -13, 0, 4635690)
	spawnMobile("rori", "trainer_commando", 0, 0, 1.13306, -13, 0, 4615374)
	spawnMobile("rori", "trainer_squadleader", 0, 5528, 80.7357, 5641, 91, 0)
	...
	spawnMobile("rori", "trainer_entertainer", 0, 21.8, 2.1, 76.2, 180, 4635754)
	spawnMobile("rori", "theater_manager", 0, 21.6954, 2.12795, 63.866, 0, 4635754)
	spawnMobile("rori", "trainer_entertainer", 0, 5432.89, 80.6, 5569.12, 270, 0)
	spawnMobile("rori", "trainer_bountyhunter", 0, 5090, 80, 5759, 180, 0)
	spawnMobile("rori", "trainer_scout", 0, -12.5744, 1.13306, 4.79458, 180, 4635688)
	spawnMobile("rori", "trainer_smuggler", 0, 5371, 80, 5539, 180, 0)
	spawnMobile("rori", "trainer_1hsword", 0, 11, 0, -13, 0, 4635663)
	spawnMobile("rori", "trainer_chef", 0, 5209, 80, 5729, 180, 0)
	spawnMobile("rori", "trainer_armorsmith", 0, 0, 1, -13, 0, 4635775)
end
