...
function NabooDeejaPeakScreenPlay:spawnMobiles()
	...
	spawnMobile("naboo", "trainer_chef", 0,-2.5,1.13306,-8.4,91,1685239)

	--Guild Hall/Theater 4963 -1475
	pNpc = spawnMobile("naboo", "shadowy_figure",60,-22.5,2.1,71.5,18,2725361)
	self:setMoodString(pNpc, "sad")
	spawnMobile("naboo", "trainer_entertainer", 0,17.8577,2.12873,53.8179,2,2725360)
	spawnMobile("naboo", "trainer_entertainer", 0,28.1,2.1,73.1,-138,2725360)
	spawnMobile("naboo", "trainer_entertainer", 0,-22.2396,2.12878,72.4933,181,2725361)
	spawnMobile("naboo", "trainer_entertainer", 0,21.7,2.1,76.3,180,2725360)
	...
	spawnMobile("naboo", "trainer_architect", 0,4715,330,-1393,77,0)
