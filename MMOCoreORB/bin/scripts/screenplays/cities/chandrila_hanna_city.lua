...
function HannaCityScreenPlay:spawnMobiles()
  ...
  pNpc = spawnMobile("tatooine", "commoner_fat",60,-3.2,-0.9,-10.8,65,35791444)
  ...
  --
  pNpc = spawnMobile("tatooine", "patron",60,13.7,-0.9,-5.6,67,35791444)
  self:setMoodString(pNpc, "npc_sitting_chair")
  pNpc = spawnMobile("tatooine", "patron",60,13.6,-0.9,-2.4,147,35791444)
  self:setMoodString(pNpc, "npc_sitting_chair")
  pNpc = spawnMobile("tatooine", "patron",60,16.3,-0.9,-5.6,320,35791444)
  self:setMoodString(pNpc, "npc_sitting_chair")
  pNpc = spawnMobile("tatooine", "patron",60,23.5,-0.9,-8.9,51,35791444)
  self:setMoodString(pNpc, "npc_sitting_table")
  pNpc = spawnMobile("tatooine", "patron",60,26.3,-0.9,-8.8,317,35791444)
  self:setMoodString(pNpc, "npc_sitting_table_eating")
  pNpc = spawnMobile("tatooine", "patron",60,19.1,-0.9,6.1,41,35791444)
  self:setMoodString(pNpc, "entertained")
  pNpc = spawnMobile("tatooine", "patron",60,22.2,-0.9,4.3,22,35791444)
  self:setMoodString(pNpc, "entertained")
  pNpc = spawnMobile("tatooine", "patron",60,-3.1,-0.9,11.6,97,35791444)
  self:setMoodString(pNpc, "npc_sitting_table")
  
  
  pNpc = spawnMobile("tatooine", "patron",60,1.2,-0.9,11.6,269,35791444)
  self:setMoodString(pNpc, "npc_sitting_chair")
  pNpc = spawnMobile("tatooine", "patron_ithorian",60,14.1,-0.9,4.3,51,35791444)
  self:setMoodString(pNpc, "npc_sitting_table")
  pNpc = spawnMobile("tatooine", "patron_klaatu",60,14.4,-0.9,7.5,139,35791444)
  self:setMoodString(pNpc, "npc_sitting_chair")
  pNpc = spawnMobile("tatooine", "patron_quarren",60,17.1,-0.9,7.8,226,35791444)
  self:setMoodString(pNpc, "npc_sitting_chair")
  --
