...
function RoriRebelOutpostScreenPlay:spawnMobiles()
	...
	spawnMobile("rori", "trainer_droidengineer", 60, 3676, 96, -6432, 90, 0)
	spawnMobile("rori", "trainer_pistol", 60, 3627, 104, -6433, 90, 0)
	...
	spawnMobile("rori", "trainer_armorsmith", 60, 3681, 96, -6420, 0, 0)
end
