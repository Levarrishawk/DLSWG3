...
function TalusDearicScreenPlay:spawnMobiles()
	...
	spawnMobile("talus", "trainer_1hsword",1,552,6,-2865,180,0)
	...
	spawnMobile("talus", "trainer_architect",1,0,1,-14,0,3175386)
	spawnMobile("talus", "trainer_rifleman",1,-11,1,-14,0,3175377)
	...
	spawnMobile("talus", "trainer_rifleman",1,586,6,-2873,0,0)
