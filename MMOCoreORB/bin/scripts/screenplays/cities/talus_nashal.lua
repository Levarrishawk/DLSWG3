...
function TalusNashalScreenPlay:spawnMobiles()
	...
	--trainers
	spawnMobile("talus", "trainer_1hsword",1,11,1.1,-11.4,0,4265405)
	spawnMobile("talus", "trainer_architect",1,11,1,-14,0,4265415)
	spawnMobile("talus", "trainer_armorsmith",1,-15,1,0,90,4265414)
	spawnMobile("talus", "trainer_droidengineer",1,0,1,-14.5,0,4265396)
	spawnMobile("talus", "trainer_architect",1,4410,2,5309,89,0)
	spawnMobile("talus", "trainer_creaturehandler",1,18,1.566,14,90,4265423)
	spawnMobile("talus", "trainer_commando",1,-11,1,-13,0,4265407)
	spawnMobile("talus", "trainer_chef",1,-11,1,-14,0,4265397)
	spawnMobile("talus", "trainer_chef",1,4283,2,5172,0,0)
	spawnMobile("talus", "trainer_medic",1,4398.7,2,5365.2,200,0)
	spawnMobile("talus", "trainer_medic",1,8,0,5.5,86,4265477)
	spawnMobile("talus", "trainer_commando",1,-3,1,-9,90,4265406)
	spawnMobile("talus", "trainer_creaturehandler",1,4467,2,5482,0,0)
	spawnMobile("talus", "trainer_medic",1,-1,0.184,-3,83,4265477)
	spawnMobile("talus", "trainer_medic",1,4491,2,5182,315,0)
	...
	spawnMobile("talus", "trainer_entertainer",1,4347,2,5054,315,0)
	...
	spawnMobile("talus", "trainer_squadleader",1,4408.3,2,5287.6,90,0)
	spawnMobile("talus", "trainer_bountyhunter",1,4234,0.5,5263,330,0)
	...
	spawnMobile("talus", "trainer_chef",1,-12,1,6,180,4265414)
	spawnMobile("talus", "trainer_chef",1,11,1,-14,0,4265395)
	spawnMobile("talus", "trainer_armorsmith",1,0,1,-14,0,4265416)
