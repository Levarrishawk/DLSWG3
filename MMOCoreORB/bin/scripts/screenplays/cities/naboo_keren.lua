...
function NabooKerenScreenPlay:spawnMobiles()
	...
	spawnMobile("naboo", "trainer_architect",0,0.0976721,1.13306,-13.6995,0,1396874)
	--Guild Hall/Theater
	spawnMobile("naboo", "trainer_entertainer",0,18.188,2.12871,53.8705,2,4045383)
	spawnMobile("naboo", "trainer_entertainer",0,29.6396,2.12878,74.0291,270,4045383)
	spawnMobile("naboo", "trainer_entertainer",0,21.7,2.1,76.2,180,4045383)
	spawnMobile("naboo", "theater_manager",0,21.7887,2.12809,63.5017,3,4045383)
	spawnMobile("naboo", "trainer_entertainer",0,-20.97,2.1287,74.23,180,4045384)
	...
	--Med Center
	spawnMobile("naboo", "trainer_medic",0,27.2188,0.26,5.37779,76,1661366)
	spawnMobile("naboo", "trainer_medic",0,-17,0.26,9,180,1661370)
	spawnMobile("naboo", "trainer_medic",0,17.4,0.3,1,9,1661366)
	spawnMobile("naboo", "trainer_medic",0,-25.9,0.3,-3.2,173,1661370)
	...
	spawnMobile("naboo", "trainer_droidengineer",0,1522,25,2781,180,0)
	spawnMobile("naboo", "trainer_chef",0,2003.71,12,2484.06,243,0)
	spawnMobile("naboo", "trainer_rifleman",0,1890,12,2725,0,0)
	spawnMobile("naboo", "trainer_pistol",0,1537,25,2757,0,0)
	spawnMobile("naboo", "trainer_bountyhunter",0,1265.08,13,2677.88,9,0)
	spawnMobile("naboo", "trainer_chef",0,1840,12,2672,180,0)
	spawnMobile("naboo", "trainer_medic",0,1927,12,2729.93,264,0)
	spawnMobile("naboo", "trainer_entertainer",0,1630.59,12,2574.54,99,0)
	...
	spawnMobile("naboo", "trainer_rifleman",0,1253,13,2711,0,0)
	...
	spawnMobile("naboo", "trainer_armorsmith",0,1905,12,2767,180,0)
