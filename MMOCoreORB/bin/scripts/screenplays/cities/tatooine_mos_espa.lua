...
function TatooineMosEspaScreenPlay:spawnMobiles()
	...
	pNpc = spawnMobile("tatooine", "poki_wirqi",60,-29.0928,1.63942,52.3406,180.009,1261660)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "awwaschlu_witubrarq",60,-29.0928,1.63942,51.3406,0,1261660)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "farmer",60,-50.0859,2.63942,33.6967,135.008,1261663)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "businessman",300,-48.9859,2.63942,33.6967,180.011,1261663)
	self:setMoodString(pNpc, "conversation")
...
--	spawnMobile("tatooine", "trainer_artisan",0,-0.0885271,1.13306,-14.0283,2,1256011)
	...
	pNpc = spawnMobile("tatooine", "dorn_gestros",60,-6.00754,-0.894992,-5.35219,231.068,1256058)
	self:setMoodString(pNpc, "calm")
	pNpc = spawnMobile("tatooine", "medic",60,12.1732,-0.894991,3.93609,180.003,1256058)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "sullustan_male",300,12.1732,-0.894992,2.93609,360.011,1256058)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "bounty_hunter",300,2.1656,-0.894992,-15.9672,360.011,1256061)
	self:setMoodString(pNpc, "calm")
	pNpc = spawnMobile("tatooine", "contractor",60,2.1656,-0.894992,-14.9672,180.001,1256061)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "commoner_tatooine",60,-20.6545,-0.894989,25.0112,0,1256067)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "noble",300,-20.6545,-0.894989,26.0112,180.01,1256067)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "da_la_socuna",60,-29.7168,-0.519991,7.77728,54.7476,1256068)
	self:setMoodString(pNpc, "conversation")
...
--	spawnMobile("tatooine", "trainer_weaponsmith",0,-2.95975,1.13306,-8.77207,109,1256022)
	...
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "noble",60,20.2715,1.28309,-0.0457823,179.998,1261018)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "medic",300,19.1715,1.28309,-0.0457823,134.998,1261018)
	self:setMoodString(pNpc, "conversation")
	spawnMobile("tatooine", "scientist",60,20.2668,1.56616,15.1105,241.986,1261018)
	pNpc = spawnMobile("tatooine", "mercenary",300,7.41432,1.00001,-5.80893,180.003,1261017)
	self:setMoodString(pNpc, "angry")
	pNpc = spawnMobile("tatooine", "commoner_technician",60,7.41432,1.00001,-6.90893,0,1261017)
	self:setMoodString(pNpc, "conversation")
	...
	--Outside
	pNpc = spawnMobile("tatooine", "anim_kahn",60,-2907.07,5,2130.14,71.993,0)
	self:setMoodString(pNpc, "neutral")
	pNpc = spawnMobile("tatooine", "brawler",60,-2918.94,5,2169.6,0,0)
	self:setMoodString(pNpc, "conversation")
	...
	pNpc = spawnMobile("tatooine", "businessman",60,-2901.2,5,2360.3,241,0)
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile("tatooine", "businessman",60,-2868.4,5,2493.9,238,0)
	self:setMoodString(pNpc, "npc_sitting_chair")
	...
	--Imperial Npc's Outside that will need to be added again with planet-swap

	--pNpc = spawnMobile("tatooine", "comm_operator",400,-2960.4,5,1973.9,74,0)
	...
	--pNpc = spawnMobile("tatooine", "dark_trooper",400,-2953.88,5,1933.16,344.533,0)
	--self:setMoodString(pNpc, "npc_imperial")
	--pNpc = spawnMobile("tatooine", "imperial_master_sergeant",400,-2954.65,5,1935.93,344.531,0)
	--self:setMoodString(pNpc, "npc_imperial")
	--pNpc = spawnMobile("tatooine", "imperial_master_sergeant",400,-3115,5,2199.8,-75,0)
	--self:setMoodString(pNpc, "npc_imperial")
	...
	--pNpc = spawnMobile("tatooine", "imperial_noncom",400,-2648.9,5,2290.2,67,0)
	--self:setMoodString(pNpc, "npc_imperial")
	--pNpc = spawnMobile("tatooine", "imperial_noncom",400,-3027.01,5.06395,2617.66,289.047,0)
	--self:setMoodString(pNpc, "npc_imperial")
	--spawnMobile("tatooine", "imperial_warrant_officer_ii",400,-3207,5,2097.52,347.895,0)
	--pNpc = spawnMobile("tatooine", "sand_trooper",400,-2985.75,5,1978.7,74.49,0)
	--self:setMoodString(pNpc, "npc_imperial")
	--pNpc = spawnMobile("tatooine", "sand_trooper",400,-2963.4,5,1978.6,75,0)
	--self:setMoodString(pNpc, "npc_imperial")
	--pNpc = spawnMobile("tatooine", "sand_trooper",400,-2988.1,5,1978.04,74.4903,0)
	--self:setMoodString(pNpc, "npc_imperial")
	--pNpc = spawnMobile("tatooine", "sand_trooper",400,-2960.1,5,1968.6,67,0)
	--self:setMoodString(pNpc, "npc_imperial")
	...
	--pNpc = spawnMobile("tatooine", "stormtrooper_captain",400,-3026.34,5.10198,2618.73,289.047,0)
	--self:setMoodString(pNpc, "npc_imperial")
	--pNpc = spawnMobile("tatooine", "stormtrooper_squad_leader",400,-2979.8,5,1957.6,67,0)
	--self:setMoodString(pNpc, "npc_imperial")
	...
	--rebel spawns that need to be added back once planet-swap functionality is in

	--pNpc = spawnMobile("tatooine", "rebel_resistance_dissident",400,-2958.4,5,1975.9,74,0)
	--self:setMoodString(pNpc, "angry")
	--spawnMobile("tatooine", "rebel_commando",400,-3026.58,5.11515,2620.21,39.6237,0)
	--spawnMobile("tatooine", "rebel_commando",400,-2634.4,5,2256.3,81,0)
	--pNpc = spawnMobile("tatooine", "rebel_commando",400,-2951.88,5,1935.16,344.533,0)
	--self:setMoodString(pNpc, "neutral")
	--pNpc = spawnMobile("tatooine", "rebel_master_sergeant",400,-2952.65,5,1937.93,344.531,0)
	--self:setMoodString(pNpc, "neutral")
	--pNpc = spawnMobile("tatooine", "rebel_master_sergeant",400,-3113,5,2201.8,-75,0)
	--self:setMoodString(pNpc, "neutral")
	--spawnMobile("tatooine", "rebel_master_sergeant",400,-3202.52,5,2089.93,204.135,0)
	--spawnMobile("tatooine", "rebel_master_sergeant",400,-3027.53,5.07697,2619.06,39.7527,0)
	--pNpc = spawnMobile("tatooine", "rebel_corporal",400,-2648.9,5,2290.2,67,0)
	--self:setMoodString(pNpc, "neutral")
	--pNpc = spawnMobile("tatooine", "rebel_corporal",400,-3027.01,5.06395,2617.66,289.047,0)
	--self:setMoodString(pNpc, "neutral")
	--spawnMobile("tatooine", "rebel_warrant_officer_ii",400,-3205,5,2099.52,347.895,0)
	--pNpc = spawnMobile("tatooine", "rebel_trooper",400,-2983.75,5,1980.7,74.49,0)
	--self:setMoodString(pNpc, "neutral")
	--pNpc = spawnMobile("tatooine", "rebel_trooper",400,-2961.4,5,1980.6,75,0)
	--self:setMoodString(pNpc, "neutral")
	--pNpc = spawnMobile("tatooine", "rebel_trooper",400,-2986.1,5,1980.04,74.4903,0)
	--self:setMoodString(pNpc, "neutral")
	--pNpc = spawnMobile("tatooine", "rebel_trooper",400,-2958.1,5,1970.6,67,0)
	--self:setMoodString(pNpc, "neutral")
	--spawnMobile("tatooine", "rebel_trooper",400,-2693.6,5,1984.9,122,0)
	--spawnMobile("tatooine", "rebel_trooper",400,-3168.7,5,2139.7,-30,0)
	--spawnMobile("tatooine", "rebel_trooper",400,-3026.33,5.01162,2618.08,294.927,0)
	--spawnMobile("tatooine", "rebel_scout",400,-2980.5,5,1958.8,73,0)
	--spawnMobile("tatooine", "rebel_scout",400,-3027.2,5,2616.8,-52,0)
	--spawnMobile("tatooine", "rebel_crewman",400,-3205.39,5,2101.33,347.898,0)
	--spawnMobile("tatooine", "rebel_crewman",400,-3201.5,5,2093.5,-159,0)
	--pNpc = spawnMobile("tatooine", "rebel_army_captain",400,-3024.34,5.10198,2620.73,289.047,0)
	--self:setMoodString(pNpc, "conversation")
	--pNpc = spawnMobile("tatooine", "rebel_resistance_leader",400,-2977.8,5,1959.6,67,0)
	--self:setMoodString(pNpc, "npc_consoling")
	...
	--Jawa's
	pNpc = spawnMobile("tatooine", "jawa",300,-2930.03,5,2038.02,270.008,0)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "jawa",300,-2932.03,5,2038.02,90.0027,0)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "jawa",300,-2931.03,5,2037.02,0,0)
	self:setMoodString(pNpc, "conversation")
	...
	pNpc = spawnMobile("tatooine", "miner",60,-2918.94,5,2170.6,180.005,0)
	self:setMoodString(pNpc, "conversation")
	...
	pNpc = spawnMobile("tatooine", "prost_roberts",60,-2906.52,5,2128.41,75.633,0)
	self:setMoodString(pNpc, "neutral")
	pNpc = spawnMobile("tatooine", "r2",60,-2928.79,5,2111.03,245.497,0)
	self:setMoodString(pNpc, "calm")
	pNpc = spawnMobile("tatooine", "r2",60,-2946.98,5,2470.9,350.917,0)
	self:setMoodString(pNpc, "calm")
	pNpc = spawnMobile("tatooine", "r4",60,-2959.44,5,2110.92,112.101,0)
	self:setMoodString(pNpc, "calm")
	pNpc = spawnMobile("tatooine", "r4",60,-2871.38,6.12074,1985.32,252.493,0)
	self:setMoodString(pNpc, "calm")
	pNpc = spawnMobile("tatooine", "r5",60,-2935.94,5,2275.75,205.483,0)
	self:setMoodString(pNpc, "calm")
	pNpc = spawnMobile("tatooine", "r5",60,-2915.25,5,2163.42,154.028,0)
	self:setMoodString(pNpc, "calm")
	pNpc = spawnMobile("tatooine", "r5",60,-2919.36,5,2262.73,15.6789,0)
	self:setMoodString(pNpc, "calm")
	pNpc = spawnMobile("tatooine", "rel_keteris",60,-2905.83,5,2127.11,255.625,0)
	self:setMoodString(pNpc, "neutral")
	...
	spawnMobile("tatooine", "lesser_desert_womp_rat",300,-3210.83,6.40006,2005.31,323.114,0)
	spawnMobile("tatooine", "lesser_desert_womp_rat",300,-3244.16,6.56426,2232.65,151.289,0)
	spawnMobile("tatooine", "lesser_desert_womp_rat",300,-3095.72,5.05761,1915.26,68.165,0)
	spawnMobile("tatooine", "lesser_desert_womp_rat",300,-2594.47,5,2219.41,202.753,0)
	spawnMobile("tatooine", "lesser_desert_womp_rat",300,-2613.3,5.16549,1956.6,191.904,0)
	spawnMobile("tatooine", "lesser_desert_womp_rat",300,-3113.6,5.65245,1908.34,35.3904,0)
	...
	spawnMobile("tatooine", "womp_rat",300,-3204.49,5.96378,2015.95,36.2798,0)
	spawnMobile("tatooine", "womp_rat",300,-3265.58,5.20889,2129.95,295.349,0)
	spawnMobile("tatooine", "womp_rat",300,-2963.31,6.41839,2664.35,19.3742,0)
	spawnMobile("tatooine", "womp_rat",300,-2593.13,5,2213.37,141.78,0)
	spawnMobile("tatooine", "womp_rat",300,-2581.69,5.15777,2031.96,201.278,0)
	spawnMobile("tatooine", "womp_rat",300,-2621.59,5.02486,1967.45,345.653,0)
	spawnMobile("tatooine", "womp_rat",300,-3103.38,5.15501,1918.82,259.068,0)
