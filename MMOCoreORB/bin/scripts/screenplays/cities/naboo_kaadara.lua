...
function NabooKaadaraScreenPlay:spawnMobiles()
	...
	--imperial garrison outside city in the outskirts to still re-add with planet-swap
	...
	--rebel squadron outside city in the outskirts but still need re-add with planet-swap

	--spawnMobile("naboo", "rebel_trooper", 300, -1.0, 0.3, 8.7, 0, 1259939)
	--spawnMobile("naboo", "rebel_trooper", 300, 1.0, 0.3, 7.2, 0, 1259939)
	--spawnMobile("naboo", "rebel_trooper", 300, 2.7, 0.3, -3.0, 0, 1259940)
	--spawnMobile("naboo", "rebel_commando", 300, -2.7, -3.3, 5.9, 180, 1259942)
	--spawnMobile("naboo", "rebel_medic", 300, 6.8, -6.8, -6.8, -65, 1259943)
	--spawnMobile("naboo", "rebel_colonel", 300, 2.5, -6.8, -5.8, 0, 1259943)
	--spawnMobile("naboo", "rebel_scout", 300, -2.7, -13.8, -19.5, 90, 1259944)
	--spawnMobile("naboo", "rebel_major", 300, -1.9, -13.7, -3.7, -45, 1259945)
	--spawnMobile("naboo", "rebel_trooper", 300, -4.1, -13.7, 8.5, 180, 1259945)
	--spawnMobile("naboo", "rebel_trooper", 300, -0.9, -13.7, 8.5, 180, 1259945)
	--spawnMobile("naboo", "rebel_medic", 300, -4.3, -13.8, 14.5, -30, 1259950)
	--spawnMobile("naboo", "rebel_general", 300, 13.7, -13.8, 6.2, 0, 1260045)
	--spawnMobile("naboo", "rebel_trooper", 300, 13.7, -13.8, 9.0, 0, 1260045)
	--spawnMobile("naboo", "rebel_trooper", 300, 13.7, -13.8, 10.8, 0, 1260045)
	--spawnMobile("naboo", "rebel_army_captain", 600, 14.1, -11.5, -21.4, 0, 1260046)
	--spawnMobile("naboo", "rebel_trooper", 300, 2.7, 0.1, 3.1, -90, 1260051)
	--spawnMobile("naboo", "rebel_trooper", 300, 1.0, 0.1, -2.9, 0, 1260050)
	--spawnMobile("naboo", "rebel_trooper", 300, -1.0, 0.1, -2.9, 0, 1260057)
	--spawnMobile("naboo", "rebel_lieutenant_colonel", 300, 4.3, 0.1, 5.5, -150, 1260058)
	--spawnMobile("naboo", "rebel_trooper", 300, 5382.5, -197.2, 6457, -97, 0)
	--spawnMobile("naboo", "rebel_trooper", 300, 5382.5, -197.2, 6460, -97, 0)
	--spawnMobile("naboo", "rebel_trooper", 300, 5379.5, -197.2, 6456.5, -97, 0)
	--spawnMobile("naboo", "rebel_trooper", 300, 5379.5, -197.2, 6459.5, -97, 0)
	--spawnMobile("naboo", "rebel_trooper", 300, 5376.5, -197.2, 6456, -97, 0)
	--spawnMobile("naboo", "rebel_trooper", 300, 5376.5, -197.2, 6459, -97, 0)
	--spawnMobile("naboo", "rebel_trooper", 300, 5373.5, -197.2, 6455.5, -97, 0)
	--spawnMobile("naboo", "rebel_trooper", 300, 5373.5, -197.2, 6458.5, -97, 0)

	--imperials in the city to be added back once planet-swap is in
	...
	--rebel spawns to be added again later with planet-swap functionality

	--spawnMobile("naboo", "rebel_trooper", 300, 5288.5, -192, 6584.2, -90, 0)
	--spawnMobile("naboo", "rebel_trooper", 300, 5292.5, -192, 6584.2, -90, 0)
	--spawnMobile("naboo", "rebel_trooper", 300, 5296.5, -192, 6584.2, -90, 0)
	--spawnMobile("naboo", "rebel_trooper", 300, getRandomNumber(20) + 5187.5, -192, getRandomNumber(28) + 6626.5, getRandomNumber(360), 0)
	--spawnMobile("naboo", "rebel_medic", 300, getRandomNumber(20) + 5187.5, -192, getRandomNumber(28) + 6626.5, getRandomNumber(360), 0)
	--spawnMobile("naboo", "rebel_gungan_bomber", 300, getRandomNumber(20) + 5187.5, -192, getRandomNumber(28) + 6626.5, getRandomNumber(360), 0)
	--spawnMobile("naboo", "rebel_trooper", 300, getRandomNumber(20) + 5187.5, -192, getRandomNumber(20) + 6626.5, getRandomNumber(360), 0)
	--spawnMobile("naboo", "rebel_trooper", 300, 5093.7, -192, 6746.4, 136, 0)
	--spawnMobile("naboo", "rebel_trooper", 300, 5103.6, -192, 6735.9, 136, 0)
	--spawnMobile("naboo", "rebel_trooper", 300, 5135.7, -192, 6694.9, 136, 0)
	--spawnMobile("naboo", "rebel_trooper", 300, 5146.6, -192, 6684.4, 136, 0)
	--spawnMobile("naboo", "rebel_trooper", 300, 5021.0, -192, 6716.8, -40, 0)
	--spawnMobile("naboo", "rebel_trooper", 300, 5009.7, -192, 6730.2, -40, 0)
	--spawnMobile("naboo", "rebel_trooper", 300, 4983.0, -192, 6765.0, 88, 0)
	...
	spawnMobile("naboo", "trainer_droidengineer", 1, -0.031573, 1.13306, -14.1498, 0, 1741510)
	spawnMobile("naboo", "trainer_chef", 1, 5182, -192, 6686, 138, 0)
	spawnMobile("naboo", "trainer_rifleman", 1, 5174.04, -192, 6639.92, 4, 0)
	spawnMobile("naboo", "trainer_pistol", 0, -11.887, 1.13306, -11.5344, 1, 1741462)
	spawnMobile("naboo", "trainer_medic", 1, 5080, -192, 6655, -49, 0)
	spawnMobile("naboo", "trainer_medic", 0, -16.368, 0.26, 11.0637, 172, 1741443)
	...
	spawnMobile("naboo", "trainer_bountyhunter", 1, 5021, -192, 6787, 2, 0)
	spawnMobile("naboo", "trainer_medic", 1, -24.4979, 0.26, -4.7603, 187, 1741443)
	spawnMobile("naboo", "trainer_medic", 1, 21.4466, 0.26, -2.96069, 37, 1741439)
	...
	spawnMobile("naboo", "trainer_entertainer", 1, 21.8, 2.1, 76.3, 180, 4105618)
	spawnMobile("naboo", "theater_manager", 1, 21.7817, 2.12808, 63.5, 1, 4105618)
	spawnMobile("naboo", "trainer_politician", 1, 5279, -192, 6591, 0, 0)
	spawnMobile("naboo", "trainer_scout", 1, 5279, -192, 6594, 180, 0)
	...
	spawnMobile("naboo", "trainer_armorsmith", 1, -2.5, 1.13306, -8.4, 91, 1741471)
