...
--	self:setMoodString(pNpc, "conversation")
	...
	spawnMobile("rori", "trainer_1hsword", 1, -5214, 80.4173, -2167, 0, 0)
	...
	spawnMobile("rori", "trainer_droidengineer", 1, -5160.97, 80, -2325.27, 137, 0)
	spawnMobile("rori", "trainer_droidengineer", 1, 0, 1.1, -13, 0, 4615384)
	spawnMobile("rori", "trainer_bountyhunter", 1, -5232, 80, -2241, 120, 0)
	spawnMobile("rori", "trainer_rifleman", 1, -11, 0, -13, 0, 4615375)
	spawnMobile("rori", "trainer_pistol", 1, -5212, 80, -2449, 180, 0)
	spawnMobile("rori", "trainer_bountyhunter", 1, -5139, 80, -2517, 90, 0)
	spawnMobile("rori", "trainer_chef", 1, -5169, 80, -2326, 140, 0)
	spawnMobile("rori", "trainer_medic", 1, -16.4, 0.26, 10.9, 180, 4635424)
	spawnMobile("rori", "trainer_medic", 1, 26.6041, 0.26, 5.45989, 83, 4635420)
	spawnMobile("rori", "trainer_commando", 1, -5181, 80, -2350, 120, 0)
	spawnMobile("rori", "trainer_medic", 1, -25.5, 0.26, -4, 180, 4635424)
	spawnMobile("rori", "trainer_medic", 1, -5104, 80, -2249, 270, 0)
	spawnMobile("rori", "trainer_medic", 1, 20.5091, 0.26, -6.05941, 12, 4635420)
	...
	spawnMobile("rori", "trainer_pistol", 1, -5278, 80, -2328, 180, 0)
	spawnMobile("rori", "trainer_politician", 1, -5165, 80, -2463, 90, 0)
	spawnMobile("rori", "trainer_scout", 1, -5167, 80, -2535, 180, 0)
	...
	spawnMobile("rori", "trainer_chef", 1, 11, 0, -13, 0, 4615383)
	spawnMobile("rori", "trainer_smuggler", 1, -5288, 79.0383, -2508, 0, 0)
	spawnMobile("rori", "trainer_weaponsmith", 1, -5274, 80, -2424, 0, 0)
	spawnMobile("rori", "trainer_weaponsmith", 1, 0, 1, -13, 0, 4635414)
	spawnMobile("rori", "trainer_entertainer", 0, 18.0876, 2.12874, 53.6634, 1, 4635403)
	spawnMobile("rori", "theater_manager", 0, 21.5522, 2.12797, 63.5137, 0, 4635403)
	spawnMobile("rori", "trainer_entertainer", 0, 21.8, 2.1, 76.4, 180, 4635403)
end
